...
function BillingDrawer({ open, onClose }: BillingDrawerProps) {
          ...
          >
            ...
            <div className='px-5 flex-1 overflow-auto space-y-4'>
              <div className='rounded-xl border border-white/10 p-4'>
                ...
                <button onClick={() => handleUpgrade('starter')} className='mt-4 w-full rounded-lg bg-indigo-600 hover:bg-indigo-700 py-2 text-white border-none cursor-pointer'>Upgrade</button>
              </div>
            </div>
            ...
            <div className='px-5 flex-1 overflow-auto space-y-4'>
              <div className='rounded-xl border border-white/10 p-4'>
                ...
                <button onClick={() => handleUpgrade('pro')} className='mt-4 w-full rounded-lg bg-indigo-600 hover:bg-indigo-700 py-2 text-white border-none cursor-pointer'>Upgrade</button>
              </div>
            </div>
          </motion.div>
        </>
