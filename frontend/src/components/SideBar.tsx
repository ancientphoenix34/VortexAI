...
import { PanelLeft as PanelLeftIcon, PanelRight, PenSquare, Plus, MessageSquare, User, Coins, LogOut, Menu, X } from 'lucide-react'
                        ...
                        {conversations.map((conv, i) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span className={`text-[13px] font-medium truncate  ${isActive ? "text-slate-200" : "text-slate-400"}`}>{conv?.title || "New Chat"}</span>
                                </div>
                            )
                        })}
                    </div>
                        ...
                        {userData ? (
                            <div className='flex items-center gap-2.5 cursor-pointer rounded-xl px-3 py-2.5 hover:bg-white/[0.05] transition-colors duration-150'>
                                ...
                                <div className='flex gap-1'>
                                    ...
                                    <button onClick={handleLogOut} className='flex items-center justify-center w-7 h-7 rounded-[7px] border-none bg-transparent text-slate-600 cursor-pointer hover:bg-white/[0.08] hover:text-slate-400 transition-all duration-150'>
                                        <LogOut size={16} />
                                    </button>
                                </div>
                            </div>)
